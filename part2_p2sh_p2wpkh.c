...
int main(void) {
    const char *WALLET = "cs216_segwit_wallet";
    ...
    printf("=== PART 2: P2SH-P2WPKH (NESTED SEGWIT) ===\n");

    char *miner = getnewaddress_rpc(&cfg, "miner", "legacy");
    char *A = getnewaddress_rpc(&cfg, "A_prime", "p2sh-segwit");
    char *B = getnewaddress_rpc(&cfg, "B_prime", "p2sh-segwit");
    char *C = getnewaddress_rpc(&cfg, "C_prime", "p2sh-segwit");
